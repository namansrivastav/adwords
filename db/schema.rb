...
ActiveRecord::Schema.define(version: 20150414124812) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "filedets", force: :cascade do |t|
    t.text     "topadurl",    default: [],              array: true
    t.text     "rightadurl",  default: [],              array: true
    t.text     "normalurl",   default: [],              array: true
